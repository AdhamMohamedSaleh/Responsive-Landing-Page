...
function Footer() {
  return (
    <footer id="footer" className="bg-gray-900">
      <div className="container flex flex-col-reverse justify-between px-6 py-10 mx-auto gap-10 lg:flex-row lg:space-y-0">
        <div className="flex flex-col-reverse gap-10 items-center lg:justify-start lg:flex-col lg:space-y-4">
